...
- [x] Explain the difference between `Relational Databases` and `SQL`.
  ...
  A relational database is a way to store persistent data. SQL is a query language that can be used to manually or programmatically interact with relational databases.

- [x] Why do tables need a `primary key`?

  Primary keys ensure that each entry in the databse has some unique identifier. This makes it easier for developers to retrieve specific data and for the database to locate that data.
...
- [x] What do we need in order to have a _many to many_ relationship between two tables.
  ...
  A third, intermediary, table which links the two tables by containing corresponding primary keys.
